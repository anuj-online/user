package com.codeverse.user.provider;
...
public class UserAuthenticationProvider implements AuthenticationProvider {
    ...
    public UserAuthenticationProvider(UserRepo repository, PasswordEncoder encoder) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        UserEntity student = repository.findByFullName(username);
        if (student == null) {
